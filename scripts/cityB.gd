...
@export var city_name: String = "CityB"

# 城市安全度：0 ~ 1
@export_range(0.0, 1.0) var safety: float = 1.0

# 简化起见，先只做一种商品：grain（粮食）
@export var stock_grain: float = 50.0      # 库存
@export var demand_grain: float = 120.0      # 需求

# 基础价格
@export var base_price_grain: float = 16.0
# 生产和消耗
@export var produce_rate: float = 0.0
@export var consume_rate: float = 6.0
